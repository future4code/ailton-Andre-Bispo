...
import { GetuserInput, GetUserInputDBDTO, User, UserEditDTO, UserInputDTO, UserOutputDTO, UserResponse, UserTokenDTO, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: GetuserInput) => {
        ...
        const getUsersInputDB: GetUserInputDBDTO = {
            search,
            order,
            sort,
            limit,
        ...
        const response: { users: UserResponse[] } = {
            users
        }
    ...
    public deleteUser = async (input: UserTokenDTO) => {
    ...
    public editUser = async (input: UserEditDTO) => {
        const {
            token,
            idToEdit,
            email,
